...
function PaginaRepresentante() {
  return (
    ...
    <CardContainer>
      <ProfileImage
        src="/imagem/sabrina.jpeg" 
        alt="Foto da representante"
      />
      <NomeEstudante>Sabrina Victoria</NomeEstudante>
      <TurmaEstudante>Turma: Módulo IV</TurmaEstudante>
      <QualidadesEstudante>
        Qualidades como representante: Excelente comunicação, comprometimento com os alunos, solucionadora de problemas.
      </QualidadesEstudante>
    </CardContainer>
    <Footer/>
    </>
